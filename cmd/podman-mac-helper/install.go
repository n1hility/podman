...
func installExecutable(user string) (string, error) {
	...
	// suffix. The goal is to help users hardern against privlige escalation from loose
	...
	// Correct any incorrect perms on previously existing directories and veriify no symlinks
